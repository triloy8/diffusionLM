...
- [trixyL/transformerlm-flow-mnist](https://hf.co/trixyL/transformerlm-flow-mnist) — MNIST image Flow-matching run (lerp, euler) 🤖🌫️ ([demo](https://huggingface.co/spaces/trixyL/mnist-flow-demo)) 
