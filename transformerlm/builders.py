...
from transformerlm.models import TransformerLM, TransformerImage, DiTImage, CategoricalFlowImage, Linear
...
def build_model(cfg) -> torch.nn.Module:
    ...
    if model_type == "image_cfm":
        return CategoricalFlowImage(
            vocab_size=cfg.vocab_size,
            context_length=cfg.context_length,
            d_model=cfg.d_model,
            num_layers=cfg.num_layers,
