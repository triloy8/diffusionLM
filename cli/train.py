...
def main():
    ...
    run_config = {
        ...
        "log_activation_norms": bool(getattr(ns, "log_activation_norms", False)),
        "log_weight_norms": bool(getattr(ns, "log_weight_norms", False)),
        "optimizer_name": ns.optimizer_name,
        "betas": ns.betas,
        "eps": ns.eps,
        "weight_decay": ns.weight_decay,
        "initial_learning_rate": ns.initial_learning_rate,
