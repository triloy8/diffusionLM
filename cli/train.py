...
def build_train_namespace(cfg_dc, config_path: str) -> argparse.Namespace:
    return argparse.Namespace(
        ...
        semicat_sd_prop=float(getattr(cfg_dc.training, "semicat_sd_prop", 0.25)),
        semicat_sd_lambda=float(getattr(cfg_dc.training, "semicat_sd_lambda", 1.0)),
        semicat_sd_type=str(getattr(cfg_dc.training, "semicat_sd_type", "lag")),
        semicat_label_smoothing=float(getattr(cfg_dc.training, "semicat_label_smoothing", 0.0)),
